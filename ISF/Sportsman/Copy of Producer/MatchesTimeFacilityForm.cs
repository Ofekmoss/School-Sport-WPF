...
namespace Sportsman.Producer
{
	...
	public class MatchesTimeFacilityForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelTime.Location = new System.Drawing.Point(312, 21);
			...
			this.dtpTime.Location = new System.Drawing.Point(8, 16);
			this.dtpTime.Name = "dtpTime";
			this.dtpTime.ShowCheckBox = true;
			this.dtpTime.Size = new System.Drawing.Size(280, 21);
			...
			this.btnOK.Location = new System.Drawing.Point(8, 359);
			...
			this.btnCancel.Location = new System.Drawing.Point(88, 359);
			...
			this.labelMatchDuration.Location = new System.Drawing.Point(288, 48);
			this.labelMatchDuration.Name = "labelMatchDuration";
			this.labelMatchDuration.Size = new System.Drawing.Size(72, 16);
			...
			this.nudMatchDuration.Location = new System.Drawing.Point(232, 44);
			this.nudMatchDuration.Maximum = new System.Decimal(new int[] {
																			 9999,
																			 0,
																			 0,
																			 0});
			this.nudMatchDuration.Name = "nudMatchDuration";
			this.nudMatchDuration.Size = new System.Drawing.Size(56, 21);
			...
			this.cbByLocation.Location = new System.Drawing.Point(142, 45);
			this.cbByLocation.Name = "cbByLocation";
			this.cbByLocation.Size = new System.Drawing.Size(80, 23);
			...
			this.gridLocations.Location = new System.Drawing.Point(8, 195);
			...
			this.gridLocations.Size = new System.Drawing.Size(352, 159);
			...
			this.btnAddLocation.Location = new System.Drawing.Point(312, 359);
			this.btnAddLocation.Name = "btnAddLocation";
			this.btnAddLocation.Size = new System.Drawing.Size(48, 23);
			...
			this.btnRemoveLocation.Location = new System.Drawing.Point(256, 359);
			this.btnRemoveLocation.Name = "btnRemoveLocation";
			this.btnRemoveLocation.Size = new System.Drawing.Size(48, 23);
			...
			this.gbFunctionaries.Location = new System.Drawing.Point(5, 70);
			...
			this.lbFuncError.Location = new System.Drawing.Point(16, 34);
			...
			this.gdFunctionaries.Location = new System.Drawing.Point(8, 26);
			...
			this.cbSetFunctionaries.Location = new System.Drawing.Point(8, 45);
			this.cbSetFunctionaries.Name = "cbSetFunctionaries";
			this.cbSetFunctionaries.Size = new System.Drawing.Size(128, 23);
		...
		private void btnOK_Click(object sender, System.EventArgs e)
		{
			...
			bool setLocation = locations.Length > 0;
			bool byLocation = cbByLocation.Checked;
			bool setFunc = cbSetFunctionaries.Checked;
			...
			int am = (int) nudMatchDuration.Value;
			...
			for (int n = 0; n < _matches.Length; n++)
			{
				if (setLocation)
				{
					court = locations[location] as Sport.Entities.Court;
					facility = court == null ? 
						locations[location] as Sport.Entities.Facility :
						court.Facility;
				}
				_matches[n].Set(_matches[n].Number, 
					setTime ? dt : _matches[n].Time, 
					setLocation ? facility : _matches[n].Facility, 
					setLocation ? court : _matches[n].Court, 
					setFunc ? arrFunctionaries : _matches[n].Functionaries);
				location++;
				if (!byLocation || !setLocation || location >= locations.Length)
					dt = dt.AddMinutes(am);
